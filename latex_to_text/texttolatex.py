...
class TextToLatex:
    ...
    def convert_text_to_latex(self, txt_file, dictionary_file=None, output_file=None):
        """
        ...
        while keep_replacing:
            ...
            for i, val in dictionary.items():
                tag_str = self.open_tag + str(i) + self.close_tag
...
if __name__ == "__main__":
    ...
    TextToLatex().convert_text_to_latex(
